...
const initialMessages: Message[] = [
  {
    role: "bot",
    content:
      "Hello! 👋 I'm your virtual dental assistant. How can I help you today?",
    options: [
  ...
  const handleOptionClick = (label: string, flowType: string) => {
    ...
    setTimeout(() => {
      if (flowType === "pain") {
        addMessage(
          "bot",
          "I'm sorry to hear that. Could you describe the pain?",
          [
            {
              label: "Sensitive to Hot/Cold",
              action: () => handleOptionClick("Sensitivity", "sensitivity"),
            },
            {
              label: "Constant Ache",
              action: () => handleOptionClick("Constant Ache", "ache"),
            },
            {
              label: "Swelling / Bleeding",
              action: () => handleOptionClick("Swelling", "gum_issue"),
            },
          ],
        );
        ...
        addMessage(
          "bot",
          "Great! We specialize in smile makeovers. What are you looking for?",
          [
            {
              label: "Whiter Teeth",
              action: () => handleOptionClick("Teeth Whitening", "whitening"),
            },
            {
              label: "Straighten Teeth",
              action: () => handleOptionClick("Braces/Aligners", "ortho"),
            },
            {
              label: "Fix Broken Tooth",
              action: () => handleOptionClick("Crowns/Veneers", "cosmetic"),
            },
          ],
        );
        ...
        addMessage(
          "bot",
          "We love treating kids! Is this for a routine checkup or a specific issue?",
          [
            {
              label: "Routine Checkup",
              action: () => handleOptionClick("Kids Checkup", "book_direct"),
            },
            {
              label: "Tooth Decay/Pain",
              action: () => handleOptionClick("Kids Pain", "book_direct"),
            },
          ],
        );
        ...
        addMessage(
          "bot",
          "This might indicate a cavity or infection. I recommend seeing a doctor soon. Would you like to book now?",
          [
        ...
        addMessage(
          "bot",
          "Bleeding or swelling often points to gum disease. Our laser treatments can help!",
          [
            { label: "Book Appointment", action: () => setActiveTab("book") },
        ...
        addMessage(
          "bot",
          "We have excellent specialists for that. Let's get you a consultation.",
          [
  ...
  const knowledgeBase = [
    {
      ...
      answer:
        "We offer painless, single-sitting Root Canal Treatments (RCT) performed by our endodontists to save infected teeth.",
      flow: "book",
    },
    {
      keywords: ["implant", "missing", "tooth loss", "permanent"],
      answer:
        "Our dental implants come with a lifetime warranty and are a permanent, natural-looking solution for missing teeth.",
      flow: "book",
    },
    {
      keywords: ["braces", "aligner", "crooked", "straight", "invisalign"],
      answer:
        "We provide invisible aligners (Invisalign) and ceramic braces for all ages to help you get that perfect smile.",
      flow: "book",
    },
    {
      keywords: ["kid", "child", "baby", "pediatric"],
      answer:
        "We have specialized pediatric dentists to ensure a fun and fear-free experience for your little ones.",
      flow: "book",
    },
    {
      keywords: ["whitening", "yellow", "bright", "clean"],
      answer:
        "Our advanced laser teeth whitening can brighten your smile in just 45 minutes.",
      flow: "book",
    },
    {
      keywords: ["cost", "price", "expensive", "charge"],
      answer:
        "We believe in transparent pricing. While exact costs depend on the treatment, we provide written estimates before starting any procedure.",
      flow: "chat",
    },
    {
      keywords: ["location", "address", "where", "sector", "chandigarh"],
      answer:
        "We are located at SCO 123, Sector 43, Chandigarh. We are the #1 Dental Chain in the city!",
      flow: "contact",
    },
    {
      keywords: ["time", "hour", "open", "close", "sunday"],
      answer:
        "We are open Monday to Saturday from 9:00 AM to 8:00 PM, and Sundays from 10:00 AM to 2:00 PM.",
      flow: "book",
    },
  ];
  ...
  const handleSendMessage = (e?: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const match = knowledgeBase.find((kb) =>
        kb.keywords.some((k) => userText.includes(k)),
      );
      ...
      if (match) {
              ...
              ? [
                  {
                    ...
                    action: () =>
                      window.open(
                        "https://maps.google.com/?q=SCO 123, Sector 43, Chandigarh",
                        "_blank",
                      ),
                  },
                ]
        ...
        addMessage(
          "bot",
          "Thank you for your message. For specific medical queries, it's best to consult our doctors directly. How would you like to proceed?",
          [
            { label: "Book Appointment", action: () => setActiveTab("book") },
            {
              label: "Call Clinic",
        ...
        options: [
          {
            ...
            action: () => handleOptionClick("I have tooth pain", "pain"),
          },
          {
            label: "Want a better smile ✨",
            action: () => handleOptionClick("Want a better smile", "smile"),
          },
          {
            label: "Book Checkup 📅",
            action: () => handleOptionClick("Book Checkup", "book_direct"),
          },
          {
            label: "For my child 👶",
            action: () => handleOptionClick("For my child", "kids"),
          },
        ],
      },
    ]);
          ...
          <CardContent className="p-0 flex-1 overflow-hidden flex flex-col">
            ...
            >
              <TabsList className="w-full grid grid-cols-2 rounded-none bg-slate-50 p-0 h-12 shrink-0 border-b">
                <TabsTrigger
                  value="chat"
                  className="data-[state=active]:bg-white data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none h-full text-slate-600"
                >
                  ...
                  >
                    ...
                    <div className="bg-blue-50 p-3 rounded-lg flex gap-2 items-start mt-4">
                      ...
                      <p className="text-xs text-blue-700">
                        We usually confirm appointments within 15 minutes during
                        working hours.
                      </p>
                    </div>
                  </form>
