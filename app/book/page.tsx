        ...
        return (
            <div className="container py-24 flex justify-center">
                <Card className="w-full max-w-md text-center">
                    <CardHeader>
                        <CardTitle className="text-2xl text-green-600">Appointment Requested!</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-muted-foreground mb-6">
                            Thank you for booking with us. We will contact you shortly to confirm your appointment time.
                        </p>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea id="message" placeholder="Any specific concerns?" className="resize-none" />
                        </div>
