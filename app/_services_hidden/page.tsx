          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                ...
                super-specialists. From routine checkups to complex surgical
                procedures, we ensure the highest standards of hygiene and
                patient safety.
              </p>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-slate-900 rounded-full px-8 h-12 bg-transparent"
            >
